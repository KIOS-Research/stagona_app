window.translations = {
    el: {
        ...
        "intro-instructions": "1️⃣ Βρες ένα <em>πρόσφατο τιμολόγιο</em> από τον οργανισμό υδροδότησής σου<br>2️⃣ Εντόπισε την <em>ολική κατανάλωση</em> σε κυβικά μέτρα (κ.μ. ή m³)*<br>3️⃣ Συμπλήρωσε τα στοιχεία και υπολόγισε πόσα λίτρα νερό χρησιμοποιείς κάθε ημέρα στο σπίτι σου<br>🤓 Μπορείτε να υπολογίσετε και μόνοι σας την ολική κατανάλωση (<a href='#' class='why-info-link'>οδηγίες</a>)<br><small>* 1 κ.μ = 1000 λίτρα</small>",
    ...
    en: {
        ...
        "intro-instructions": "1️⃣ Find a <em>recent bill</em> from your water utility organization<br>2️⃣ Locate the <em>total consumption</em> in cubic meters (m³)<br>3️⃣ Fill in the details and calculate how many liters of water you use every day in your home<br>🤓 You can also calculate your total consumption yourself (<a href='#' class='why-info-link'>instructions</a>)<br><br>* 1 m³ = 1000 L",
