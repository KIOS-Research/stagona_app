window.translations = {
    el: {
        ...
        "intro-instructions": "<strong>Οδηγίες</strong>: Βρες ένα <em>πρόσφατο τιμολόγιο</em> από τον οργανισμό υδροδότησής σου, εντόπισε την <em>ολική κατανάλωση</em> σε κυβικά μέτρα (κ.μ. ή m³)*, συμπλήρωσε τα στοιχεία και υπολόγισε πόσα λίτρα νερό χρησιμοποιείς κάθε ημέρα στο σπίτι σου.<br>* 1 κ.μ = 1000 L",
        ...
        "share-title": "Καθορίστε το στόχο σας, και μοιραστείτε τον με οικογένεια και φίλους:",
    ...
    en: {
        ...
        "share-title": "Set your target, and share with friends and family:",
        "copy-success": "Copied!",
